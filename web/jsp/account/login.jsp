					...
					<ul class="nav pull-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li><a
									href="http://markable.in/file/fa30c686-9dc0-11e1-8ea2-984be164924a/"
									target="_blank">FAQ</a></li>
								<li><a
									href="http://markable.in/file/aa191728-9dc7-11e1-91c7-984be164924a/"
									target="_blank">Markdown Syntax Cheat Sheet</a></li>
								<li class="divider"></li>
